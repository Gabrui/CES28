...
public class SIAPJ {
	...
	public void criaReclamacao(IProcesso processo) throws SQLException {
		//1) Checa se o processo est� no formato correto
		...
		if (result==true){
			...
			//2.2 envia uma mensagem de e-mail para o usu�rio que o processo foi aceito 
			email.sendEmail(processo.getEmail(), "Processo aceito");
		}
		
		else {
			//3) se estiver incorreto, ele envia uma mensagem de e-mail para o usu�rio informando os problemas.
