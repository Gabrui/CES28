...
public class MoneyList {
	...
	//interesting example: do not want to expose the internal list publicly
	// but with no private or public keywork, this is package-private
	// it is visible only inside the same java package
	List<Money> getMonies() { return _monies; }
	...
	public boolean equals(Object anObject) {
		...
		return _monies.equals(otherlist.getMonies());
		...
		// if we want the lists to be considered equal even with different ordering
		// we must implement our logic instead of using List<>.equals()
	}//equals
